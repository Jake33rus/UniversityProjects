...
public class DoodleView extends View {
    ...
    public void drawCircle(float cx, float cy, float rad) {
        Paint paint = new Paint();
        paint.setColor(paintLine.getColor());
        paint.setStyle(Paint.Style.FILL);
        bitmapCanvas.drawCircle(cx,cy,rad,paint);
    }
    public void drawRect(float left, float right, float top, float bottom)
    {
        Paint paint = new Paint();
        paint.setColor(paintLine.getColor());
        paint.setStyle(Paint.Style.FILL);
